MixusMousillonUnitCapResourceFilters = {
    factions_tables_data__ = {
        FileName = "factions_tables_!!_mousillon_qb.tsv",
        Directory = "MixuTSVs",
        OutputFile = false,
    ...
    units_to_groupings_military_permissions_tables_data__ = {
        FileName = "units_to_groupings_military_permissions_tables_mixu_mousillon.tsv",
        Directory = "MixuTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    UnitPoolData = {
        ...
        ChildFiles = {
            MixusMousillonUnitPoolData = {
                FileName = "MixusMousillonUnitPoolData.lua",
                Filter = {
                    {
