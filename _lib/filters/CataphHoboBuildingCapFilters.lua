CataphHoboBuildingCapFilters = {
    building_units_allowed_tables_data__ = {
        FileName = {"building_units_allowed_tables_AK_hobo.tsv", },
    ...
    building_levels_tables_data__ = {
        FileName = {"building_levels_tables_AK_hobo.tsv", },
        Directory = "CataphTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    building_chain_availability_sets_tables_data__ = {
        FileName = "building_chain_availability_sets_tables_AK_hobo.tsv",
        Directory = "CataphTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    main_units_tables_data__ = {
        FileName = {"main_units_tables_AK_hobo.tsv", "main_units_tables_AK_hobo_vanillaish.tsv", },
        Directory = "CataphTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    BuildCapPoolData = {
        ...
        ChildFiles = {
            HoboBuildingPoolData = {
                FileName = "HoboBuildingPoolData.lua",
                Filter = {
                    {
                        -- Building Chain Key
