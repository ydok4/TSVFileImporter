MixusMousillonBuildingCapFilters = {
    building_units_allowed_tables_data__ = {
        FileName = "building_units_allowed_tables_ab_mixus_mousillon.tsv",
        Directory = "MixuTSVs",
        OutputFile = false,
    ...
    building_levels_tables_data__ = {
        FileName = "building_levels_tables_ab_mixus_mousillon.tsv",
        Directory = "MixuTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    building_chain_availability_sets_tables_data__ = {
        FileName = "building_chain_availability_sets_tables_ab_mixus_mousillon.tsv",
        Directory = "MixuTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    main_units_tables_data__ = {
        FileName = {"main_units_tables_mixu_mousillon_vanilla_units.tsv", "main_units_tables_ab_mixu_mousillon.tsv"},
        Directory = "MixuTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    BuildCapPoolData = {
        ...
        ChildFiles = {
            MixusMousillonBuildingPoolData = {
                FileName = "MixusMousillonBuildingPoolData.lua",
                Filter = {
                    {
                        -- Building Chain Key
