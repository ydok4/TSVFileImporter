CataphSeaHelmsUnitCapResourceFilters = {
    factions_tables_data__ = {
        FileName = "factions_tables_AK_seahelm.tsv",
    ...
    units_to_groupings_military_permissions_tables_data__ = {
        FileName = "units_to_groupings_military_permissions_tables_AK_seahelm.tsv",
        Directory = "CataphTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    UnitPoolData = {
        ...
        ChildFiles = {
            CataphSeaHelmsUnitPoolData = {
                FileName = "CataphSeaHelmsUnitPoolData.lua",
                Filter = {
                    {
