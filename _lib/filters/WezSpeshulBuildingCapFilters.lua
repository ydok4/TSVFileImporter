WezSpeshulBuildingCapFilters = {
    building_units_allowed_tables_data__ = {
        FileName = "building_units_allowed_tables_ws_units.tsv",
    ...
    main_units_tables_data__ = {
        FileName = "main_units_tables_ws_units.tsv",
        Directory = "WezSpeshulTSVs",
        OutputFile = false,
        -- Filters work on a per column basis
        -- Each index in the filter object correlates to
    ...
    BuildCapPoolData = {
        ...
        ChildFiles = {
            WezSpeshulGreenskinBuildingPoolData = {
                FileName = "WezSpeshulGreenskinBuildingPoolData.lua",
                Filter = {
                    {
                        -- Building Chain Key
            ...
            WezSpeshulSavageOrcBuildingPoolData = {
                FileName = "WezSpeshulSavageOrcBuildingPoolData.lua",
                Filter = {
                    {
                        -- Building Chain Key
                        -- Ideally we would use the key but for specials this should be the same
