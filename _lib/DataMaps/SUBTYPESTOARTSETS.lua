-- This is to cover the agent sub types which share the same arts set
-- and don't have an agent sub type table
SUBTYPESTOARTSET = {
    wh2_dlc09_tmb_liche_priest_death = "tmb_liche_priest",
    wh2_dlc09_tmb_liche_priest_light = "tmb_liche_priest",
    wh2_dlc09_tmb_liche_priest_nehekhara = "tmb_liche_priest",
    wh2_dlc09_tmb_liche_priest_shadow = "tmb_liche_priest",

    wh2_dlc10_hef_mage_heavens = "hef_mage",
    wh2_dlc10_hef_mage_shadows = "hef_mage",
    wh2_main_hef_mage_high = "hef_mage",
    ...
    dlc03_bst_bray_shaman_beasts = "bst_bray_shaman",
    dlc03_bst_bray_shaman_death = "bst_bray_shaman",
    dlc03_bst_bray_shaman_shadows = "bst_bray_shaman",
    dlc03_bst_bray_shaman_wild = "bst_bray_shaman",
