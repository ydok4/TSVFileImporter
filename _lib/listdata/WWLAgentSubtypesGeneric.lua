...
local agentSubTypes = {
        ...
        -- Missing the evasion skill
        --[[dlc06_grn_wurrzag_da_great_prophet = {
            IsLord = true,
            DefaultWizardLevel = 3,
            Lore = "BigWaaagh",
        },--]]
        -- Needs to disable lore of death until gets crown of sorcery
