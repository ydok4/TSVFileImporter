HighElfInfluentialLordTransforms = {
    agent_subtypes_tables_a_intrigue_skills_high_elves = {
        ...
        STEP2 = {
            -- The name of the file this transform operation is to be applied to
            FileName = "campaign_character_art_sets_tables_a_intrigue_skills_high_elves",
            -- In an operation if the condition is met,
            -- Then the transforms are applied
            Filters = {
        ...
        STEP3 = {
            -- The name of the file this transform operation is to be applied to
            FileName = "campaign_character_arts_tables_a_intrigue_skills_high_elves",
            -- In an operation if the condition is met,
            -- Then the transforms are applied
            Filters = {
                -- Agent Sub Type Column
            ...
            Transforms = {
                {
                    ...
                    Operations = {
                        ...
                        OPERATION2 = {
                            ...
                            -- Index of column from indicated step
                            Value = {
                                File = "campaign_character_arts_tables_a_intrigue_skills_high_elves",
                                -- Art set id
                                TargetColumn = "1",
                                -- Uniform column
                                ReturnColumn = "6",
